...
public class InformationPage {
    ...
    @FindBy(css = "input#field-new_password ~ span button")
    private WebElement showNewPasswordButton;
    ...
    public void typeNewPasswordInput(String newPassword) {
        ElementHelper.fillInput(driver, newPasswordInput, newPassword);
    }

    public void clickShowNewPasswordButton() {
        ElementHelper.clickButton(driver, showNewPasswordButton);
    }
